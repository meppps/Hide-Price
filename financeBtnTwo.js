function variationCorrection(){
    ...
    selectors.forEach((selectors) =>{      
        function selectorEvents(){
            selectors.addEventListener('change', () => {
                ...
                // Prevent duplicates of financing button
                var leaseButton = document.querySelector('.LeaseStationButton')
                if(leaseButton == null){
                ...
                }else{console.log('Duplicate Prevented')};
        });
        };
    ...
    setTimeout(function checkpage(){
	    ...
	    console.log("%c If you're reading this, have a pleasant day", "background: #f4f4f4; color: #00a4e4");
        }else{
